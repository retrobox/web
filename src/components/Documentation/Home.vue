        ...
        <div>
          ...
          <div class="navigation">
            <ul class="list-reset flex justify-between">
              ...
              <li class="mr-3">
                <a class="inline-block border border-blue rounded py-2 px-4 bg-blue hover:bg-blue-dark text-white" @click="$router.push({name: 'DocumentationPage', params: {slug: items[0].slug}});">{{$t('next')}}</a>
              </li>
            </ul>
          </div>
        </div>
