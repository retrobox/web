...
export const store = new Vuex.Store({
    ...
    mutations: {
        ...
        CART_EMPTY(state) {
            state.cart = [];
            state.shipping_total_price = 0.00
        }
    },
    plugins: [createPersistedState({key: 'data_persited_vuex', paths: ['cart', 'cart_length', 'shipping_total_price']})]
});
